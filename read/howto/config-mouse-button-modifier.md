...
執行上面兩個指令後，就可以[在視窗操作下面兩個動作](https://samwhelp.github.io/note-about-fedora-budgie/read/config/mousebind.html#視窗內容區塊)，
...
為了避免無謂的干擾，我會執行下面指令來[停用這個功能](https://samwhelp.github.io/note-about-fedora-budgie/read/howto/disable-keybind-open-budgie-menu.html)。
...
| 相關議題 |
| ------- |
| [滑鼠按鍵綁定](https://samwhelp.github.io/note-about-fedora-budgie/read/config/mousebind.html#視窗內容區塊)
