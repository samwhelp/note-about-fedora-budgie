...
mod_budgie_config_for_keybind_main () {
	...
	gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-left "['<Alt>a', '<Control><Alt>Left']"


	gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-right "['<Alt>s', '<Control><Alt>Right']"
